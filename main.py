...
- Keep the vocabulary note practical for oral communication. Use this exact format: English word or phrase + IPA in slashes + brief simple Chinese meaning, for example: "example /ɪɡˈzæmpəl/: 例子". Never write Chinese pinyin or romanization after Chinese characters, for example do not write "例子 (zìlì)".
